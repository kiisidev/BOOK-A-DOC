  ...
  return (
    <>
      ...
      <nav
        className={`${
          toggle ? "open" : ""
        } mobile-nav flex fixed h-[100vh] bg-transparent backdrop-blur-lg  z-30 w-full  items-center justify-center flex-col  lg:flex-row lg:justify-between lg:items-center lg:h-16  lg:static  lg:border-b-[1px] lg:border-b-white-300  lg:pl-8 `}
      >
